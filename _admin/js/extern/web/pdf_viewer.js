...
class AnnotationLayerBuilder {
  ...
  constructor({
    ...
    this.onSignatureClick = onSignatureClick;
...
class PDFPageView {
  ...
  constructor(options) {
    ...
    this.onSignatureClick = options.onSignatureClick;
...
var _text_layer_builder = __w_pdfjs_require__(19);
var _xfa_layer_builder = __w_pdfjs_require__(20);
const pdfjsVersion = '3.5.114';
const pdfjsBuild = '384bd9616';
